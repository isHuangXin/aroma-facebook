...
public class ConvertJava {
    ...
    ArrayList<String> localVarContexts =
            new ArrayList<String>(Arrays.asList("variableDeclaratorId", "primary", "catchClause", "lambdaParameters"));
    ...
    public void openWriter(String file) throws FileNotFoundException {
        System.out.println("openWriter - file is " + file);
    ...
    public void serializeFile(String f, String startSymbol) {
        try {
            ...
            System.out.println(
                    "Success - Total processed files, Successfully processed file, total methods: "
                            + totalFiles
                            + ", "
                            + successFullFiles
                            + ", "
            ...
            System.out.println(
                    "Exception - Total processed files, Successfully processed file, total methods: "
                            + totalFiles
                            + ", "
                            + successFullFiles
                            + ", "
    ...
    private void setClassName(String thisRuleName, RuleContext t, int i) {
        if (thisRuleName.equals("classDeclaration") && i > 0) {
            ...
            if (prev instanceof TerminalNodeImpl && curr instanceof TerminalNodeImpl && prev.getText().equals("class")) {
        ...
        if (thisClassName != null && thisRuleName.equals("methodBody")) {
            if (simpleTree.length() == 2) {
                try {
                    ...
                    e.printStackTrace();
                    System.out.println("dumpMethodAst - Exception - In " + thisFileName + ":" + thisClassName + ":" + thisMethodName+":"+beginLine);
                    return;
                }
            }
            ...
            writer.flush();
            totalMethods++;
            System.out.println("dumpMethodAst - Logged " + thisFileName + ":" + thisClassName + ":" + thisMethodName);
        }
    }
    ...
    public static void main(String args[]) throws IOException {
        // 转化codebase时用的到参数
        // args[0] = "compilationUnit";
        // args[1] = "/Users/huangxin/code/java/aroma-convert-java/outputs/codebase_convert/jsrc.json";
        // args[2] = "/Users/huangxin/code/java/aroma-convert-java/datasets/codebase_all/jsrc";

        // 转换query时用到的参数
        args[0] = "compilationUnit";
        args[1] = "/Users/huangxin/code/java/aroma-convert-java/outputs/query_convert/query_test.json";
        args[2] = "/Users/huangxin/code/java/aroma-convert-java/datasets/query_all/test_all";
