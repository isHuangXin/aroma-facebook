...
def featurize_records_file(rpath, wpath):
    print(" featurize_records_file = rpath ", rpath, " wpath ", wpath)
    #logging.info("featurize_records_file = rpath ", rpath, " wpath ", wpath)
...
def load_all(counter_path, asts_path):
    print(f"load_all  {counter_path}   {asts_path}")
...
def setup(records_file):
    print("-setup - records_file ", records_file)
    #logging.info("setup - records_file ", records_file)
    global config
    global vocab
    ...
    if records_file is None:
        ...
        featurize_records_file(records_file, os.path.join(options.working_dir, config.FEATURES_FILE))
        vocab.dump()
...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store",
        dest="corpus",
        default="/Users/huangxin/code/java/aroma-convert-java/outputs/codebase_convert/jsrc.json",
    ...
    parser.add_argument(
        ...
        action="store",
        dest="working_dir",
        default="/Users/huangxin/code/java/aroma-convert-java/outputs/codebase_all_featurize_asts",
    ...
    parser.add_argument(
        ...
        action="append",
        dest="file_query",
        default=['/Users/huangxin/code/java/aroma-convert-java/outputs/query_convert/query_test.json'],
        # default="/Users/huangxin/code/java/aroma-convert-java/outputs/query_convert/query_test.json",
